...
Everything runs on the device. The app declares no network permission and never sends anything itself; Android device backup may include the progress, and a save file or daily result leaves only when the player shares it.
